    ...
    def handle(self, *args, **options):
        ...
        created_or_updated = [
            ...
            self._upsert_document(
                ...
                title="Demo Official Letter",
                description="Safe placeholder official letter shared with the student.",
                original_filename="demo-official-letter.pdf",
            ...
            self._upsert_document(
                ...
                description="Safe placeholder medical supporting document type only.",
